 ...
 *
 */
class MeldeStudiengangKzFehlt extends PlausiChecker
{
	public function executePlausiCheck($params)
	{
		...
		$prestudentRes = $this->_getMeldeStudiengangKzFehlt(
	 ...
	 */
	private function _getMeldeStudiengangKzFehlt(
		...
		$status_kurzbz = $this->_ci->config->item('fhc_dvuh_status_kurzbz')['BISUHSTAT0'] ?? null;
		...
		$qry = "
			...
			WHERE
				(stg.melde_studiengang_kz IS NULL OR stg.melde_studiengang_kz = '')
