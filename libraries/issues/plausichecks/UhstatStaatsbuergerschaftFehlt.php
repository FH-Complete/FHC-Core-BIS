...
class UhstatStaatsbuergerschaftFehlt extends PlausiChecker
{
	public function executePlausiCheck($params)
	{
		...
		$prestudentRes = $this->_getStaatsbuergerschaftFehlt(
	 ...
	 */
	private function _getStaatsbuergerschaftFehlt(
		...
		$qry = "
			...
			WHERE
				(pers.staatsbuergerschaft IS NULL OR pers.staatsbuergerschaft = '')
